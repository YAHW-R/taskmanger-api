...
router.get("/", (req, res) => {
    try {
        const description = (0, description_1.getProjectDescription)();
...
router.post("/project-name", (req, res) => {
    ...
    try {
        (0, description_1.editPojectName)(name);
...
router.post("/general-information", (req, res) => {
    ...
    try {
        (0, description_1.editProjectGeneralInformation)(generalInformation);
...
router.post("/general-functions", (req, res) => {
    ...
    try {
        (0, description_1.setPojectGeneralFunctions)(functions);
...
router.put("/general-functions", (req, res) => {
    ...
    try {
        (0, description_1.addProjectGeneralFunction)(functionName);
...
router.post("/structure", (req, res) => {
    ...
    try {
        (0, description_1.setProjectStructure)(structure);
...
router.put("/structure", (req, res) => {
    ...
    try {
        (0, description_1.addProjectStructure)(structure);
...
router.post("/set-admin-password", (req, res) => {
    ...
    try {
        (0, description_1.setAdminPassword)(password);
